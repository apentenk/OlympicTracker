        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div>
                        <form class=" w-3/6 mx-auto" action="{{ route('sports.update', $sport->id) }}" method="post">
                            {{ method_field('PUT') }}
                            @if ($errors->any())
                            ...
                            <div class="mb-3">
                                ...
                                <x-text-input type="text" class="block mt-1 w-full" id="name" name="name" aria-
                                    describedby="name" value="{{$sport->name}}" />
                            </div>
                            <div class="mb-3">
                                ...
                                <x-text-input type="text" class="block mt-1 w-full" id="sport" name="sport" aria-
                                    describedby="sport" value="{{$sport->sport}}" />
                            </div>
                            <div class="mb-3">
                                ...
                                <select id="division" name="division" aria- describedby="division"
                                    ...
                                    <option class="text-xl text-gray-300" value="Men's"
                                        @selected($sport->division == "Men's")>Men's</option>
                                    <option class="text-xl text-gray-300" value="Women's"
                                        @selected($sport->division == "Women's")>Women's</option>
                                    <option class="text-xl text-gray-300" value="Mixed"
                                        @selected($sport->division == "Mixed")>Mixed</option>
                                </select>
                            </div>
